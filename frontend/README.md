...
NEXT_PUBLIC_DEMO_QUEST_ID=0x0900000000000000000000000000000000000000000000000000000000000009
```
...
- VALUE = `0`（そのままでOK）
- `questId`: `0x0900000000000000000000000000000000000000000000000000000000000009`
...
- `questId`: `0x0900000000000000000000000000000000000000000000000000000000000009`（プレフィックス `questId:` は不要。値だけ貼る）
- 「transact」→ 完了
